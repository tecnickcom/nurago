<!-- Generated by resources/gendoc/gendoc.sh from timeutil.go. Do not edit. -->

# timeutil

[![Go Reference](https://pkg.go.dev/badge/github.com/tecnickcom/nurago/pkg/timeutil.svg)](https://pkg.go.dev/github.com/tecnickcom/nurago/pkg/timeutil)
...
Full source is in [example_datetime_test.go](example_datetime_test.go).
More runnable examples are on [pkg.go.dev](https://pkg.go.dev/github.com/tecnickcom/nurago/pkg/timeutil#pkg-examples).
...
- [Reference documentation](https://pkg.go.dev/github.com/tecnickcom/nurago/pkg/timeutil)
- [Package page](https://nurago.org/packages/timeutil/)
