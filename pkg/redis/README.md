<!-- Generated by resources/gendoc/gendoc.sh from redis.go. Do not edit. -->

# redis

[![Go Reference](https://pkg.go.dev/badge/github.com/tecnickcom/nurago/pkg/redis.svg)](https://pkg.go.dev/github.com/tecnickcom/nurago/pkg/redis)
...
Full source is in [example_redis_test.go](example_redis_test.go).
More runnable examples are on [pkg.go.dev](https://pkg.go.dev/github.com/tecnickcom/nurago/pkg/redis#pkg-examples).
