<!-- Generated by resources/gendoc/gendoc.sh from redact.go. Do not edit. -->

# redact

[![Go Reference](https://pkg.go.dev/badge/github.com/tecnickcom/nurago/pkg/redact.svg)](https://pkg.go.dev/github.com/tecnickcom/nurago/pkg/redact)
...
Full source is in [example_redact_test.go](example_redact_test.go).
More runnable examples are on [pkg.go.dev](https://pkg.go.dev/github.com/tecnickcom/nurago/pkg/redact#pkg-examples).
...
- [Reference documentation](https://pkg.go.dev/github.com/tecnickcom/nurago/pkg/redact)
- [Package page](https://nurago.org/packages/redact/)
